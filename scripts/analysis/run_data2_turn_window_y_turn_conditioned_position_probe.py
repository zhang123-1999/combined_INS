...
EXP_ID_DEFAULT = "EXP-20260319-data2-turn-window-y-turn-conditioned-position-r1"
...
OUTPUT_DIR_DEFAULT = Path("output/data2_turn_window_y_turn_conditioned_position_probe")
...
def variant_specs() -> list[VariantSpec]:
    return [
        VariantSpec(
            ...
            -1.0,
            -1.0,
            "joint baseline reference",
        ),
        VariantSpec(
            "joint_pos_gain_0p5_ref",
            "joint_pos_gain_0p5_ref",
            1,
            0.5,
            1.0,
            ...
            -1.0,
            -1.0,
            "current shared reference without turn-conditioned y fix",
        ),
        VariantSpec(
            "joint_pos_gain_0p5_lgx_from_y_0p75_ref",
            "joint_pos_gain_0p5_lgx_from_y_0p75_ref",
            2,
            0.5,
            0.75,
            ...
            -1.0,
            -1.0,
            "x reference family: retain pos_gain=0.5 and suppress K(lgx, meas_y) to 75%",
        ),
        VariantSpec(
            "joint_pos_gain_0p5_lgx_from_y_0p5_ref",
            "joint_pos_gain_0p5_lgx_from_y_0p5_ref",
            3,
            0.5,
            0.5,
            ...
            -1.0,
            -1.0,
            "x reference family: retain pos_gain=0.5 and suppress K(lgx, meas_y) to 50%",
        ),
        VariantSpec(
            ...
            -1.0,
            -1.0,
            "x reference family: retain pos_gain=0.5 and suppress K(lgx, meas_y) to 25%",
        ),
        VariantSpec(
            "joint_pos_gain_0p5_pos_turn_0p25",
            "joint_pos_gain_0p5_pos_turn_0p25",
            5,
            0.5,
            1.0,
            ...
            -1.0,
            "apply stronger position suppression only when omega_z indicates strong positive turn",
        ),
        VariantSpec(
            "joint_pos_gain_0p5_lgx_from_y_0p75_pos_turn_0p25",
            "joint_pos_gain_0p5_lgx_from_y_0p75_pos_turn_0p25",
            6,
            0.5,
            0.75,
            ...
            POSITIVE_TURN_POSITION_GAIN_SCALE,
            -1.0,
            "combine positive-turn y-side position mitigation with lgx<-y suppression 0.75",
        ),
        VariantSpec(
            "joint_pos_gain_0p5_lgx_from_y_0p5_pos_turn_0p25",
            "joint_pos_gain_0p5_lgx_from_y_0p5_pos_turn_0p25",
            7,
            0.5,
            0.5,
            ...
            POSITIVE_TURN_POSITION_GAIN_SCALE,
            -1.0,
            "combine positive-turn y-side position mitigation with lgx<-y suppression 0.50",
        ),
        VariantSpec(
            "joint_pos_gain_0p5_lgx_from_y_0p25_pos_turn_0p25",
            "joint_pos_gain_0p5_lgx_from_y_0p25_pos_turn_0p25",
            8,
            0.5,
            0.25,
            ...
            POSITIVE_TURN_POSITION_GAIN_SCALE,
            -1.0,
            "combine positive-turn y-side position mitigation with lgx<-y suppression 0.25",
        ),
    ]
...
def write_summary(output_path: Path, case_meta_rows: list[dict[str, Any]], case_summary_df: pd.DataFrame) -> None:
    ...
    lines: list[str] = []
    lines.append("# data2 turn-window y turn-conditioned position probe")
    lines.append("")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Probe turn-conditioned GNSS_POS position competition mitigation for y-axis lever recovery."
    )
